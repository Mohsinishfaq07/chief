...
class UserCompletedOrders extends StatefulWidget {
  const UserCompletedOrders({super.key});

  @override
  State<UserCompletedOrders> createState() => _UserCompletedOrdersState();
}

class _UserCompletedOrdersState extends State<UserCompletedOrders> {
                                              ...
                                              Navigator.push(
                                                ...
                                                MaterialPageRoute(
                                                  builder: (context) =>
                                                      ChefDetailsScreen(
                                                          userid: request
                                                              .acceptedChiefId), // Use clientId from RequestModel
                                                ),
                                              );
                                            },
                                          ),
