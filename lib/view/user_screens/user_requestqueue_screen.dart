...
import '../../provider/user_requestqueue_provider.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
          ...
          /// muhsin code
          // Consumer<UserRequestQueueProvider>(
          //     builder: (context, requestQueue, _) {
          //   return StreamBuilder(
          //     stream: FirebaseFirestore.instance
          ...
          //                                 color: Colors.green,
          //                                 onPressed: () {
          //                                   database.acceptRequestAndUpdateVisibility(document.id); // Update status and visibility
          //                                 },
          //                               ),
          //
          //                             ],
