  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
          ...
          child: Consumer<UserMyRequsets>(builder: (context, myrequests, _) {
            return StreamBuilder(
              ...
              builder: (BuildContext context,
                ...
                if (snapshot.hasData) {
                  myrequests.updateRequests(snapshot.data!.docs);
                  return Expanded(
                    child: ListView.builder(
                      itemCount: myrequests.requests.length,
                      itemBuilder: (BuildContext context, int index) {
                        DocumentSnapshot document = myrequests.requests[index];
